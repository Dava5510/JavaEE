...
public class Oauth2Config extends AuthorizationServerConfigurerAdapter {
    ...
    //@Autowired
//    public Oauth2Config(AuthenticationManager authenticationManager, BCryptPasswordEncoder passwordEncoder, JwtAccessTokenConverter jwtAccessTokenConverter, TokenStore tokenStore) {
